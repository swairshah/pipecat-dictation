...
def remember_window(name: str, wait_seconds: int = 3) -> Dict[str, any]:
    ...
    try:
        ...
        if success and name in controller.window_map:
            ...
            return {
                "success": False,
                "error": "Failed to capture window information"
            }
...
def send_text_to_window(
    ...
    if not controller.window_map:
        return {
            "success": False,
            "error": "No windows remembered. Use remember_window first."
        }
...
def focus_window(window_name: Optional[str] = None) -> Dict[str, any]:
    ...
    try:
        ...
        if success:
            ...
            return {
                "success": False,
                "error": f"Failed to focus window '{target}'"
            }
    except Exception as e:
        return {
            "success": False,
